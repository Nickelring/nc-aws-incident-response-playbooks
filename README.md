...
## Background
This playbook is created from the IR plans templates provided by AWS. The location for the original text is https://github.com/aws-samples/aws-incident-response-playbooks.
